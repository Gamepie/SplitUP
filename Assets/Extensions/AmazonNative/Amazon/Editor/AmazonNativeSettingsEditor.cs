...
public class AmazonNativeSettingsEditor : Editor {
	...
	private void GeneralOptions() {
		...
		if(AmazonNativeSettings.Instance.ShowActions) {
			...
			if(GUILayout.Button("Remove Amazon Libraries",  GUILayout.Width(200))) {
				SA_FileStaticAPI.DeleteFolder("Plugins/Amazon");
				SA_FileStaticAPI.DeleteFolder("Plugins/AmazonCommon");
				SA_FileStaticAPI.DeleteFolder("Plugins/AmazonGameCirclePlugin");
				SA_FileStaticAPI.DeleteFolder("Plugins/Android/Advertising_Res");
				SA_FileStaticAPI.DeleteFolder("Plugins/Android/assets");
				SA_FileStaticAPI.DeleteFolder("Plugins/Android/Billing_Res");
				SA_FileStaticAPI.DeleteFolder("Plugins/Android/GameCircle_Res");

				SA_FileStaticAPI.DeleteFile("Plugins/AmazonGameCircleLicense.txt");
				SA_FileStaticAPI.DeleteFile("Plugins/AmazonGameCircleNotice.txt");
				SA_FileStaticAPI.DeleteFile("Plugins/AmazonGameCirclePluginVersion.txt");

				SA_FileStaticAPI.DeleteFile("Plugins/Android/libs/armeabi/libAmazonIapV2Bridge.so");
				SA_FileStaticAPI.DeleteFile("Plugins/Android/libs/armeabi/libAmazonMobileAdsBridge.so");

				SA_FileStaticAPI.DeleteFile("Plugins/Android/libs/armeabi-v7a/libAmazonIapV2Bridge.so");
				SA_FileStaticAPI.DeleteFile("Plugins/Android/libs/armeabi-v7a/libAmazonMobileAdsBridge.so");

				SA_FileStaticAPI.DeleteFile("Plugins/Android/libs/x86/libAmazonIapV2Bridge.so");
				SA_FileStaticAPI.DeleteFile("Plugins/Android/libs/x86/libAmazonMobileAdsBridge.so");

				SA_FileStaticAPI.DeleteFile("Plugins/Android/AmazonCptPluginsUtils-1.0.jar");
				SA_FileStaticAPI.DeleteFile("Plugins/Android/AmazonIapV2Client.jar");
				SA_FileStaticAPI.DeleteFile("Plugins/Android/AmazonIapV2JavaService-1.0.jar");
				SA_FileStaticAPI.DeleteFile("Plugins/Android/AmazonInsights-android-sdk.jar");
				SA_FileStaticAPI.DeleteFile("Plugins/Android/AmazonMobileAdsAndroidSDK3P-1.1.jar");
				SA_FileStaticAPI.DeleteFile("Plugins/Android/AmazonMobileAdsClient.jar");
				SA_FileStaticAPI.DeleteFile("Plugins/Android/AmazonMobileAdsJavaService-1.0.jar");
				SA_FileStaticAPI.DeleteFile("Plugins/Android/amazonnative.jar");
				SA_FileStaticAPI.DeleteFile("Plugins/Android/gamecirclesdk.jar");
				SA_FileStaticAPI.DeleteFile("Plugins/Android/gcunity.jar");
				SA_FileStaticAPI.DeleteFile("Plugins/Android/gson-2.2.4.jar");
				SA_FileStaticAPI.DeleteFile("Plugins/Android/in-app-purchasing-2.0.61.jar");
				SA_FileStaticAPI.DeleteFile("Plugins/Android/login-with-amazon-sdk.jar");



				SA_FileStaticAPI.DeleteFile("Plugins/IOS/AMAZONAd.h");
				SA_FileStaticAPI.DeleteFile("Plugins/IOS/AMAZONAd.m");
				SA_FileStaticAPI.DeleteFile("Plugins/IOS/AMAZONAd.m");
				SA_FileStaticAPI.DeleteFile("Plugins/IOS/AMAZONAdPair.h");
				SA_FileStaticAPI.DeleteFile("Plugins/IOS/AMAZONAdPair.m");
				SA_FileStaticAPI.DeleteFile("Plugins/IOS/AMAZONAdPosition.h");
				SA_FileStaticAPI.DeleteFile("Plugins/IOS/AMAZONAdPosition.m");
				SA_FileStaticAPI.DeleteFile("Plugins/IOS/AMAZONAdShown.m");
				SA_FileStaticAPI.DeleteFile("Plugins/IOS/AMAZONAdShown.h");
				SA_FileStaticAPI.DeleteFile("Plugins/IOS/AMAZONAmazonMobileAds.h");
				SA_FileStaticAPI.DeleteFile("Plugins/IOS/AMAZONAmazonMobileAdsBridge.mm");
				SA_FileStaticAPI.DeleteFile("Plugins/IOS/AMAZONAmazonMobileAdsBridge.h");
				SA_FileStaticAPI.DeleteFile("Plugins/IOS/AMAZONAmazonMobileAdsImpl.h");

				SA_FileStaticAPI.DeleteFile("Plugins/IOS/AMAZONAmazonMobileAdsImpl.m");
				SA_FileStaticAPI.DeleteFile("Plugins/IOS/AMAZONAmazonMobileAdsImplStub.m");
				SA_FileStaticAPI.DeleteFile("Plugins/IOS/AMAZONAmazonMobileAdsImplStub.h");
				SA_FileStaticAPI.DeleteFile("Plugins/IOS/AMAZONAmazonMobileAdsJsonFromObject.m");
				SA_FileStaticAPI.DeleteFile("Plugins/IOS/AMAZONAmazonMobileAdsJsonFromObject.h");
				SA_FileStaticAPI.DeleteFile("Plugins/IOS/AMAZONAmazonMobileAdsObjectFromJson.h");
				SA_FileStaticAPI.DeleteFile("Plugins/IOS/AMAZONAmazonMobileAdsObjectFromJson.m");
				SA_FileStaticAPI.DeleteFile("Plugins/IOS/AMAZONAmazonMobileAdsObjectiveCController.h");
				SA_FileStaticAPI.DeleteFile("Plugins/IOS/AMAZONAmazonMobileAdsObjectiveCControllerImpl.m");
				SA_FileStaticAPI.DeleteFile("Plugins/IOS/AMAZONAmazonMobileAdsObjectiveCControllerImpl.h");
				SA_FileStaticAPI.DeleteFile("Plugins/IOS/AMAZONApplicationKey.m");
				SA_FileStaticAPI.DeleteFile("Plugins/IOS/AMAZONApplicationKey.h");

				SA_FileStaticAPI.DeleteFile("Plugins/IOS/AMAZONEnums.m");
				SA_FileStaticAPI.DeleteFile("Plugins/IOS/AMAZONEnums.h");
				SA_FileStaticAPI.DeleteFile("Plugins/IOS/AmazonInsightsSDK.a");
				SA_FileStaticAPI.DeleteFile("Plugins/IOS/AMAZONIsEqual.h");
				SA_FileStaticAPI.DeleteFile("Plugins/IOS/AMAZONIsEqual.m");
				SA_FileStaticAPI.DeleteFile("Plugins/IOS/AMAZONIsReady.h");
				SA_FileStaticAPI.DeleteFile("Plugins/IOS/AMAZONIsReady.m");
				SA_FileStaticAPI.DeleteFile("Plugins/IOS/AMAZONLoadingStarted.m");
				SA_FileStaticAPI.DeleteFile("Plugins/IOS/AMAZONLoadingStarted.h");
				SA_FileStaticAPI.DeleteFile("Plugins/IOS/AMAZONPlacement.h");
				SA_FileStaticAPI.DeleteFile("Plugins/IOS/AMAZONPlacement.m");
				SA_FileStaticAPI.DeleteFile("Plugins/IOS/AMAZONShouldEnable.h");
				SA_FileStaticAPI.DeleteFile("Plugins/IOS/AMAZONShouldEnable.m");

				SA_FileStaticAPI.DeleteFile("Plugins/IOS/GameCircle.h");
				SA_FileStaticAPI.DeleteFile("Plugins/IOS/GameCircle.a");
				SA_FileStaticAPI.DeleteFile("Plugins/IOS/libGameCircleUnityProxy.a");
				SA_FileStaticAPI.DeleteFile("Plugins/IOS/AMAZONIsEqual.h");
				SA_FileStaticAPI.DeleteFile("Plugins/IOS/AMAZONIsEqual.m");
				SA_FileStaticAPI.DeleteFile("Plugins/IOS/AMAZONIsReady.h");
				SA_FileStaticAPI.DeleteFile("Plugins/IOS/AMAZONIsReady.m");
				...
				SA_FileStaticAPI.DeleteFolder("Plugins/IOS/GameCircle.bundle");
	...
	public static void UpdatePluginSettings() {
		if(AmazonNativeSettings.Instance.IsGameCircleEnabled) {
			if(!SA_FileStaticAPI.IsFolderExists("Plugins/Android/GameCircle_Res")) {
		...
		if(AmazonNativeSettings.Instance.IsAdvertisingEnabled) {
			if(!SA_FileStaticAPI.IsFolderExists("Plugins/Android/Advertising_Res")) {
		...
		if(AmazonNativeSettings.Instance.IsBillingEnabled) {
			if(!SA_FileStaticAPI.IsFolderExists("Plugins/Android/Billing_Res")) {
	...
	private static void Update_GC_State() {
		SA_FileStaticAPI.DeleteFile("Plugins/Android/AndroidManifest 1.xml");
		SA_FileStaticAPI.DeleteFile("Plugins/Android/AndroidManifest 2.xml");

		SA_EditorTool.ChnageDefineState(SA_AmazonGameCircleManager_Path, "AMAZON_CIRCLE_ENABLED", AmazonNativeSettings.Instance.IsGameCircleEnabled);
		SA_EditorTool.ChnageDefineState(GC_Achievement_Path, "AMAZON_CIRCLE_ENABLED", AmazonNativeSettings.Instance.IsGameCircleEnabled);
		SA_EditorTool.ChnageDefineState(GC_Leaderboard_Path, "AMAZON_CIRCLE_ENABLED", AmazonNativeSettings.Instance.IsGameCircleEnabled);
		SA_EditorTool.ChnageDefineState(GC_Player_Path, "AMAZON_CIRCLE_ENABLED", AmazonNativeSettings.Instance.IsGameCircleEnabled);
		SA_EditorTool.ChnageDefineState(GC_ScoreTimeSpan_Path, "AMAZON_CIRCLE_ENABLED", AmazonNativeSettings.Instance.IsGameCircleEnabled);
	}
	...
	private static void Update_Billing_State() {
		...
		SA_EditorTool.ChnageDefineState(SA_AmazonBillingManager_Path, 					"AMAZON_BILLING_ENABLED", AmazonNativeSettings.Instance.IsBillingEnabled);
		SA_EditorTool.ChnageDefineState(Billing_GetUserDataResponse_Path, 				"AMAZON_BILLING_ENABLED", AmazonNativeSettings.Instance.IsBillingEnabled);
		SA_EditorTool.ChnageDefineState(Billing_PurchaseResponse_Path, 					"AMAZON_BILLING_ENABLED", AmazonNativeSettings.Instance.IsBillingEnabled);
		SA_EditorTool.ChnageDefineState(Billing_GetProductDataResponse_Path, 			"AMAZON_BILLING_ENABLED", AmazonNativeSettings.Instance.IsBillingEnabled);
		SA_EditorTool.ChnageDefineState(Billing_GetPurchaseProductsUpdateResponse_Path, "AMAZON_BILLING_ENABLED", AmazonNativeSettings.Instance.IsBillingEnabled);
		SA_EditorTool.ChnageDefineState(Billing_AmazonProductTemplate_Path, 			"AMAZON_BILLING_ENABLED", AmazonNativeSettings.Instance.IsBillingEnabled);
		SA_EditorTool.ChnageDefineState(Billing_AmazonReceipt_Path, 					"AMAZON_BILLING_ENABLED", AmazonNativeSettings.Instance.IsBillingEnabled);
	}
	...
	void GameCircleSettings () {
		...
		AmazonNativeSettings.Instance.IsGameCircleEnabled = SA_EditorTool.ToggleFiled("Game Circle API", AmazonNativeSettings.Instance.IsGameCircleEnabled);
		...
		EditorGUI.indentLevel++; {
			...
			if(AmazonNativeSettings.Instance.ShowLeaderboards) {
				...
				foreach(GC_Leaderboard leaderboard in AmazonNativeSettings.Instance.Leaderboards) {
					...
					bool ItemWasRemoved = SA_EditorTool.SrotingButtons((object) leaderboard, AmazonNativeSettings.Instance.Leaderboards);
					if(ItemWasRemoved) {
						return;
					}
		...
		EditorGUI.indentLevel++; {
			...
			if(AmazonNativeSettings.Instance.ShowAchievementsParams) {
				...
				foreach(GC_Achievement achievement in AmazonNativeSettings.Instance.Achievements) {
					...
					bool ItemWasRemoved = SA_EditorTool.SrotingButtons((object) achievement, AmazonNativeSettings.Instance.Achievements);
					if(ItemWasRemoved) {
						return;
					}
	...
	private void BillingSettings() {
		...
		EditorGUI.BeginChangeCheck();
		AmazonNativeSettings.Instance.IsBillingEnabled = SA_EditorTool.ToggleFiled("Billing API", AmazonNativeSettings.Instance.IsBillingEnabled);
		if(EditorGUI.EndChangeCheck())  {
			UpdatePluginSettings();
		}
	...
	public static void UpdateVersionInfo() {
		SA_FileStaticAPI.Write(SA_VersionsManager.AMN_VERSION_INFO_PATH, AmazonNativeSettings.VERSION_NUMBER);
	}
